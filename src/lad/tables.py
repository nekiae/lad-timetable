...
def check_norms(school: School) -> list[str]:
    ...
    # арифметически, и солвер вернёт INFEASIBLE, ничего не объяснив.
        ...
        for c in school.classes:
            ...
            if hours > max_days:
                warnings.append(
                    ...
                    f"{days}-дневной неделе. Расписание не составится, пока норма стоит "
                    f"«жёстко»: ослабьте её до «мягко» или перенесите час в шестой школьный день"
                )
