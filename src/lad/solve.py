...
PREFERENCES = [
    ...
    {"key": "peak_day", "group": "Трудность недели", "reference": 3, "default": 2,
     "title": "Пик трудности в дни наибольшей работоспособности",
     "about": "П. 94 ССЭТ: вторник, среда и (или) пятница. Школа может выбрать свои дни."},
...
RULE_TITLES = {
    ...
    "peak_days": "Пик нагрузки в дни наибольшей работоспособности",
