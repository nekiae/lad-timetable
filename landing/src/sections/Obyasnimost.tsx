      ...
      <div className="mx-auto max-w-[62ch]">
        ...
        <figure className="mt-8 border-l-2 border-no bg-no-soft/60 py-5 pl-6 pr-5">
          <blockquote className="text-[17px] leading-relaxed text-ink">
            ...
            48 уроков, на 24 меньше, чем нужно.{" "}
            <strong className="font-semibold">
              Расписания с этой нормой не существует.
            </strong>{" "}
            Выходы: переключить её на «мягко», или указать в кабинетах, что в
            зале занимается больше классов сразу, или перенести часть часов в
